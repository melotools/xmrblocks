...
FROM index.docker.io/melotools/monero-explorer:dependencies1 as builder_monero
WORKDIR /data
# BUILD_PATH:
...
FROM index.docker.io/melotools/monero-explorer:builder_monero as builder
WORKDIR /data
